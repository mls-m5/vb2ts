...
(function (TokenType) {
    ...
    TokenType[TokenType["VariableDeclarationGroup"] = 35] = "VariableDeclarationGroup";
    TokenType[TokenType["ParanthesisGroup"] = 36] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 37] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 38] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 39] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 40] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 41] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 42] = "MethodArguments";
    TokenType[TokenType["ForLoop"] = 43] = "ForLoop";
    TokenType[TokenType["EndStatement"] = 44] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 45] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 46] = "ElseStatement";
    TokenType[TokenType["MethodCall"] = 47] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 48] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 49] = "DeclarationName";
    TokenType[TokenType["WithStatement"] = 50] = "WithStatement";
    TokenType[TokenType["WithTarget"] = 51] = "WithTarget";
    TokenType[TokenType["MemberName"] = 52] = "MemberName";
    TokenType[TokenType["MemberNameGroup"] = 53] = "MemberNameGroup";
    TokenType[TokenType["WithMemberGroup"] = 54] = "WithMemberGroup";
    TokenType[TokenType["DeclarationSeparator"] = 55] = "DeclarationSeparator";
    TokenType[TokenType["ExitStatement"] = 56] = "ExitStatement";
    TokenType[TokenType["OptionStatement"] = 57] = "OptionStatement";
    TokenType[TokenType["NextStatement"] = 58] = "NextStatement";
    TokenType[TokenType["CommentStatement"] = 59] = "CommentStatement";
    TokenType[TokenType["ForStart"] = 60] = "ForStart";
    TokenType[TokenType["ForStop"] = 61] = "ForStop";
    TokenType[TokenType["ForStep"] = 62] = "ForStep";
    TokenType[TokenType["ForVariableName"] = 63] = "ForVariableName";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 64] = "FunctionName";
    TokenType[TokenType["VariableName"] = 65] = "VariableName";
})(TokenType || (TokenType = {}));
