...
(function (TokenType) {
    ...
    TokenType[TokenType["VariableDeclarationGroup"] = 39] = "VariableDeclarationGroup";
    TokenType[TokenType["ParanthesisGroup"] = 40] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 41] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 42] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 43] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 44] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 45] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 46] = "MethodArguments";
    TokenType[TokenType["ForLoop"] = 47] = "ForLoop";
    TokenType[TokenType["EndStatement"] = 48] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 49] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 50] = "ElseStatement";
    TokenType[TokenType["MethodCall"] = 51] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 52] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 53] = "DeclarationName";
    TokenType[TokenType["WithStatement"] = 54] = "WithStatement";
    TokenType[TokenType["WithTarget"] = 55] = "WithTarget";
    TokenType[TokenType["MemberName"] = 56] = "MemberName";
    TokenType[TokenType["MemberNameGroup"] = 57] = "MemberNameGroup";
    TokenType[TokenType["WithMemberGroup"] = 58] = "WithMemberGroup";
    TokenType[TokenType["DeclarationSeparator"] = 59] = "DeclarationSeparator";
    TokenType[TokenType["ExitStatement"] = 60] = "ExitStatement";
    TokenType[TokenType["OptionStatement"] = 61] = "OptionStatement";
    TokenType[TokenType["NextStatement"] = 62] = "NextStatement";
    TokenType[TokenType["CommentStatement"] = 63] = "CommentStatement";
    TokenType[TokenType["Identifier"] = 64] = "Identifier";
    TokenType[TokenType["CallStatement"] = 65] = "CallStatement";
    TokenType[TokenType["SelectCaseStatement"] = 66] = "SelectCaseStatement";
    TokenType[TokenType["SelectCaseTarget"] = 67] = "SelectCaseTarget";
    TokenType[TokenType["CaseStatement"] = 68] = "CaseStatement";
    TokenType[TokenType["CaseElseStatement"] = 69] = "CaseElseStatement";
    TokenType[TokenType["ForStart"] = 70] = "ForStart";
    TokenType[TokenType["ForStop"] = 71] = "ForStop";
    TokenType[TokenType["ForStep"] = 72] = "ForStep";
    TokenType[TokenType["ForVariableName"] = 73] = "ForVariableName";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 74] = "FunctionName";
    TokenType[TokenType["VariableName"] = 75] = "VariableName";
})(TokenType || (TokenType = {}));
