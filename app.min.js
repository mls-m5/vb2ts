...
(function (TokenType) {
    ...
    TokenType[TokenType["VariableDeclarationGroup"] = 30] = "VariableDeclarationGroup";
    TokenType[TokenType["ParanthesisGroup"] = 31] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 32] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 33] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 34] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 35] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 36] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 37] = "MethodArguments";
    TokenType[TokenType["Loop"] = 38] = "Loop";
    TokenType[TokenType["EndStatement"] = 39] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 40] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 41] = "ElseStatement";
    TokenType[TokenType["MethodCall"] = 42] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 43] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 44] = "DeclarationName";
    TokenType[TokenType["WithStatement"] = 45] = "WithStatement";
    TokenType[TokenType["WithTarget"] = 46] = "WithTarget";
    TokenType[TokenType["MemberName"] = 47] = "MemberName";
    TokenType[TokenType["MemberNameGroup"] = 48] = "MemberNameGroup";
    TokenType[TokenType["WithMemberGroup"] = 49] = "WithMemberGroup";
    TokenType[TokenType["DeclarationSeparator"] = 50] = "DeclarationSeparator";
    TokenType[TokenType["ExitStatement"] = 51] = "ExitStatement";
    TokenType[TokenType["OptionStatement"] = 52] = "OptionStatement";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 53] = "FunctionName";
    TokenType[TokenType["VariableName"] = 54] = "VariableName";
})(TokenType || (TokenType = {}));
    ...
    Statement.prototype.toString = function () {
        ...
        switch (this.type) {
            ...
            case TokenType.FunctionDeclaration:
                var functionName = this.getByType(TokenType.FunctionName).text;
                if (functionName == "new") {
