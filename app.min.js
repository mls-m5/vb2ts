...
(function (TokenType) {
    ...
    TokenType[TokenType["AndKeyword"] = 33] = "AndKeyword";
    TokenType[TokenType["OrKeyword"] = 34] = "OrKeyword";
    TokenType[TokenType["MeKeyword"] = 35] = "MeKeyword";
    TokenType[TokenType["CallKeyword"] = 36] = "CallKeyword";
    TokenType[TokenType["SelectKeyword"] = 37] = "SelectKeyword";
    TokenType[TokenType["CaseKeyword"] = 38] = "CaseKeyword";
    TokenType[TokenType["NothingKeyword"] = 39] = "NothingKeyword";
    TokenType[TokenType["ChrFunctionName"] = 40] = "ChrFunctionName";
    TokenType[TokenType["VariableDeclarationGroup"] = 41] = "VariableDeclarationGroup";
    TokenType[TokenType["ParanthesisGroup"] = 42] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 43] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 44] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 45] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 46] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 47] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 48] = "MethodArguments";
    TokenType[TokenType["ForLoop"] = 49] = "ForLoop";
    TokenType[TokenType["EndStatement"] = 50] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 51] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 52] = "ElseStatement";
    TokenType[TokenType["HangingIfStatement"] = 53] = "HangingIfStatement";
    TokenType[TokenType["MethodCall"] = 54] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 55] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 56] = "DeclarationName";
    TokenType[TokenType["WithStatement"] = 57] = "WithStatement";
    TokenType[TokenType["WithTarget"] = 58] = "WithTarget";
    TokenType[TokenType["MemberName"] = 59] = "MemberName";
    TokenType[TokenType["MemberNameGroup"] = 60] = "MemberNameGroup";
    TokenType[TokenType["WithMemberGroup"] = 61] = "WithMemberGroup";
    TokenType[TokenType["DeclarationSeparator"] = 62] = "DeclarationSeparator";
    TokenType[TokenType["ExitStatement"] = 63] = "ExitStatement";
    TokenType[TokenType["OptionStatement"] = 64] = "OptionStatement";
    TokenType[TokenType["NextStatement"] = 65] = "NextStatement";
    TokenType[TokenType["CommentStatement"] = 66] = "CommentStatement";
    TokenType[TokenType["Identifier"] = 67] = "Identifier";
    TokenType[TokenType["CallStatement"] = 68] = "CallStatement";
    TokenType[TokenType["SelectCaseStatement"] = 69] = "SelectCaseStatement";
    TokenType[TokenType["SelectCaseTarget"] = 70] = "SelectCaseTarget";
    TokenType[TokenType["CaseStatement"] = 71] = "CaseStatement";
    TokenType[TokenType["CaseElseStatement"] = 72] = "CaseElseStatement";
    TokenType[TokenType["ForStart"] = 73] = "ForStart";
    TokenType[TokenType["ForStop"] = 74] = "ForStop";
    TokenType[TokenType["ForStep"] = 75] = "ForStep";
    TokenType[TokenType["ForVariableName"] = 76] = "ForVariableName";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 77] = "FunctionName";
    TokenType[TokenType["VariableName"] = 78] = "VariableName";
})(TokenType || (TokenType = {}));
...
function setTranslation(original, target) {
...
var Token = (function () {
    ...
    Token.prototype.toString = function () {
        var translation = keywordTranslations[this.type];
    ...
    Statement.prototype.toString = function () {
        ...
        switch (this.type) {
            ...
            case TokenType.IfStatement:
                ...
                var conditionText = this.getByType(TokenType.Condition).toString();
                interpreterContext.setScope(ScopeType.Function); //Set the scope without pushing a new one
                var hangingStatement = this.getByType(TokenType.HangingIfStatement);
                var hangingStatementString = "";
                if (hangingStatement) {
...
(function (ScopeType) {
    ...
    ScopeType[ScopeType["Condition"] = 5] = "Condition";
})(ScopeType || (ScopeType = {}));
var InterpreterContext = (function () {
    function InterpreterContext() {
        ...
        this.classVariables = {};
        this.localVariables = {};
        this.caseCount = 0; //A counter for the select case statements to add a break after each select case
    }
    ...
    Interpreter.prototype.processStatement = function (statement, context) {
        ...
        if (statement.isStatement) {
                ...
                if (tokens[i].type == TokenType.MemberNameGroup &&
                    ...
                    for (var j = i - 1; j > 0; --j) {
                        ...
                        if (j == 1 || t2.type != TokenType.MemberNameGroup && t2.type != TokenType.Word) {
                            var identifierStatement = new Statement(TokenType.Identifier);
            ...
            if (first.type == TokenType.FunctionKeyword || first.type == TokenType.MethodKeyword) {
                ...
                var argStatement = new Statement(TokenType.MethodArguments);
                ...
                for (var i = 1; i < tokens.length; ++i) {
                    if (tokens[i].type == TokenType.ThenKeyword) {
                        ...
                        if (tokens.length == 3) {
                            ...
                            var hangingStatement = new Statement(TokenType.Line);
                            hangingStatement.setTokens(tokens.splice(3, tokens.length - 3));
                            hangingStatement = this.processStatement(hangingStatement);
                            var ifHangingStatement = new Statement(TokenType.HangingIfStatement);
