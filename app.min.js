...
(function (TokenType) {
    ...
    TokenType[TokenType["VariableDeclarationGroup"] = 28] = "VariableDeclarationGroup";
    TokenType[TokenType["ParanthesisGroup"] = 29] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 30] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 31] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 32] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 33] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 34] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 35] = "MethodArguments";
    TokenType[TokenType["Loop"] = 36] = "Loop";
    TokenType[TokenType["EndStatement"] = 37] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 38] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 39] = "ElseStatement";
    TokenType[TokenType["MethodCall"] = 40] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 41] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 42] = "DeclarationName";
    TokenType[TokenType["WithStatement"] = 43] = "WithStatement";
    TokenType[TokenType["WithTarget"] = 44] = "WithTarget";
    TokenType[TokenType["MemberName"] = 45] = "MemberName";
    TokenType[TokenType["MemberNameGroup"] = 46] = "MemberNameGroup";
    TokenType[TokenType["WithMemberGroup"] = 47] = "WithMemberGroup";
    TokenType[TokenType["DeclarationSeparator"] = 48] = "DeclarationSeparator";
    TokenType[TokenType["ExitStatement"] = 49] = "ExitStatement";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 50] = "FunctionName";
    TokenType[TokenType["VariableName"] = 51] = "VariableName";
})(TokenType || (TokenType = {}));
    ...
    Token.prototype.toString = function () {
        switch (this.type) {
            ...
            case TokenType.DeclarationType:
                var t = typeTranslation[this.rawText];
                if (t) {
                    return this.wrap(t);
                }
                else {
    ...
    Statement.prototype.toString = function () {
        ...
        switch (this.type) {
            ...
            case TokenType.VariableDeclarationGroup:
                var variableName = this.getByType(TokenType.DeclarationName).text;
                if (interpreterContext.currentScope == ScopeType.Class) {
