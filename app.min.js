...
(function (TokenType) {
    ...
    TokenType[TokenType["VariableDeclarationGroup"] = 32] = "VariableDeclarationGroup";
    TokenType[TokenType["ParanthesisGroup"] = 33] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 34] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 35] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 36] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 37] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 38] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 39] = "MethodArguments";
    TokenType[TokenType["ForLoop"] = 40] = "ForLoop";
    TokenType[TokenType["EndStatement"] = 41] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 42] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 43] = "ElseStatement";
    TokenType[TokenType["MethodCall"] = 44] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 45] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 46] = "DeclarationName";
    TokenType[TokenType["WithStatement"] = 47] = "WithStatement";
    TokenType[TokenType["WithTarget"] = 48] = "WithTarget";
    TokenType[TokenType["MemberName"] = 49] = "MemberName";
    TokenType[TokenType["MemberNameGroup"] = 50] = "MemberNameGroup";
    TokenType[TokenType["WithMemberGroup"] = 51] = "WithMemberGroup";
    TokenType[TokenType["DeclarationSeparator"] = 52] = "DeclarationSeparator";
    TokenType[TokenType["ExitStatement"] = 53] = "ExitStatement";
    TokenType[TokenType["OptionStatement"] = 54] = "OptionStatement";
    TokenType[TokenType["NextStatement"] = 55] = "NextStatement";
    TokenType[TokenType["ForStart"] = 56] = "ForStart";
    TokenType[TokenType["ForStop"] = 57] = "ForStop";
    TokenType[TokenType["ForStep"] = 58] = "ForStep";
    TokenType[TokenType["ForVariableName"] = 59] = "ForVariableName";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 60] = "FunctionName";
    TokenType[TokenType["VariableName"] = 61] = "VariableName";
})(TokenType || (TokenType = {}));
    ...
    Statement.prototype.toString = function () {
        ...
        switch (this.type) {
            ...
            case TokenType.VariableDeclarationGroup:
                var variableName = this.getByType(TokenType.DeclarationName).rawText;
