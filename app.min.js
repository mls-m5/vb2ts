...
(function (TokenType) {
    ...
    TokenType[TokenType["VariableDeclarationGroup"] = 40] = "VariableDeclarationGroup";
    TokenType[TokenType["ParanthesisGroup"] = 41] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 42] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 43] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 44] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 45] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 46] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 47] = "MethodArguments";
    TokenType[TokenType["ForLoop"] = 48] = "ForLoop";
    TokenType[TokenType["EndStatement"] = 49] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 50] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 51] = "ElseStatement";
    TokenType[TokenType["MethodCall"] = 52] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 53] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 54] = "DeclarationName";
    TokenType[TokenType["WithStatement"] = 55] = "WithStatement";
    TokenType[TokenType["WithTarget"] = 56] = "WithTarget";
    TokenType[TokenType["MemberName"] = 57] = "MemberName";
    TokenType[TokenType["MemberNameGroup"] = 58] = "MemberNameGroup";
    TokenType[TokenType["WithMemberGroup"] = 59] = "WithMemberGroup";
    TokenType[TokenType["DeclarationSeparator"] = 60] = "DeclarationSeparator";
    TokenType[TokenType["ExitStatement"] = 61] = "ExitStatement";
    TokenType[TokenType["OptionStatement"] = 62] = "OptionStatement";
    TokenType[TokenType["NextStatement"] = 63] = "NextStatement";
    TokenType[TokenType["CommentStatement"] = 64] = "CommentStatement";
    TokenType[TokenType["Identifier"] = 65] = "Identifier";
    TokenType[TokenType["CallStatement"] = 66] = "CallStatement";
    TokenType[TokenType["SelectCaseStatement"] = 67] = "SelectCaseStatement";
    TokenType[TokenType["SelectCaseTarget"] = 68] = "SelectCaseTarget";
    TokenType[TokenType["CaseStatement"] = 69] = "CaseStatement";
    TokenType[TokenType["CaseElseStatement"] = 70] = "CaseElseStatement";
    TokenType[TokenType["ForStart"] = 71] = "ForStart";
    TokenType[TokenType["ForStop"] = 72] = "ForStop";
    TokenType[TokenType["ForStep"] = 73] = "ForStep";
    TokenType[TokenType["ForVariableName"] = 74] = "ForVariableName";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 75] = "FunctionName";
    TokenType[TokenType["VariableName"] = 76] = "VariableName";
})(TokenType || (TokenType = {}));
