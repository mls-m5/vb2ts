...
(function (TokenType) {
    ...
    TokenType[TokenType["ParanthesisGroup"] = 25] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 26] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 27] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 28] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 29] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 30] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 31] = "MethodArguments";
    TokenType[TokenType["Loop"] = 32] = "Loop";
    TokenType[TokenType["EndStatement"] = 33] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 34] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 35] = "ElseStatement";
    TokenType[TokenType["MethodCall"] = 36] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 37] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 38] = "DeclarationName";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 39] = "FunctionName";
    TokenType[TokenType["VariableName"] = 40] = "VariableName";
})(TokenType || (TokenType = {}));
...
var VariableDeclaration = (function (_super) {
    ...
    function VariableDeclaration(statement) {
        _super.call(this, statement);
        this.type = TokenType.VariableDeclaration;
    }
...
var FunctionDeclaration = (function (_super) {
    ...
    function FunctionDeclaration(statement) {
        _super.call(this, statement);
        this.type = TokenType.FunctionDeclaration;
    }
...
var Tokenizer = (function () {
    ...
    Tokenizer.prototype.processStatement = function (statement) {
    ...
    Tokenizer.prototype.group = function (tokens) {
...
$(document).ready(function () {
    ...
    $vb_text.on("change keyup paste", function () {
        ...
        var statements = tokenizer.group(tokens);
        var output = "";
