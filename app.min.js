...
(function (TokenType) {
    ...
    TokenType[TokenType["VariableDeclarationGroup"] = 26] = "VariableDeclarationGroup";
    TokenType[TokenType["ParanthesisGroup"] = 27] = "ParanthesisGroup";
    TokenType[TokenType["FunctionArguments"] = 28] = "FunctionArguments";
    TokenType[TokenType["Condition"] = 29] = "Condition";
    TokenType[TokenType["FunctionDeclaration"] = 30] = "FunctionDeclaration";
    TokenType[TokenType["Assignment"] = 31] = "Assignment";
    TokenType[TokenType["AssignmentTarget"] = 32] = "AssignmentTarget";
    TokenType[TokenType["MethodArguments"] = 33] = "MethodArguments";
    TokenType[TokenType["Loop"] = 34] = "Loop";
    TokenType[TokenType["EndStatement"] = 35] = "EndStatement";
    TokenType[TokenType["IfStatement"] = 36] = "IfStatement";
    TokenType[TokenType["ElseStatement"] = 37] = "ElseStatement";
    TokenType[TokenType["MethodCall"] = 38] = "MethodCall";
    TokenType[TokenType["DeclarationType"] = 39] = "DeclarationType";
    TokenType[TokenType["DeclarationName"] = 40] = "DeclarationName";
    TokenType[TokenType["WithStatement"] = 41] = "WithStatement";
    TokenType[TokenType["WithTarget"] = 42] = "WithTarget";
    TokenType[TokenType["MemberName"] = 43] = "MemberName";
    TokenType[TokenType["MemberNameGroup"] = 44] = "MemberNameGroup";
    TokenType[TokenType["WithMemberGroup"] = 45] = "WithMemberGroup";
    //Name of higher analysis
    TokenType[TokenType["FunctionName"] = 46] = "FunctionName";
    TokenType[TokenType["VariableName"] = 47] = "VariableName";
})(TokenType || (TokenType = {}));
